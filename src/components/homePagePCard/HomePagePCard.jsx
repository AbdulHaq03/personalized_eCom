...
const HomePageProductCard = () => {
    ...
    return (
        <div className="mt-10">
            {/* Heading  */}
            <div className="">
                <h1 className="text-center mb-5 text-2xl font-semibold text-gray-800">Bestselling Products</h1>
            </div>
                        ...
                        return (
                            <div key={category}>
                                ...
                                <div className="mb-8 mt-6">
                                    <h2 className="text-3xl font-bold text-gray-900 mb-2">{'Featured ' + category}</h2>
